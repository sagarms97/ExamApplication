...
public partial class Pages_ExamMaster : System.Web.UI.Page
{
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (string.IsNullOrEmpty(lblslno.Text))
            {
            ...
            DateTime examTimeFrom = DateTime.ParseExact(_TimeFrom, "dd-MM-yyyy h:mm tt", null);
            DateTime examTimeTo = DateTime.ParseExact(_TimeTo, "dd-MM-yyyy h:mm tt", null);

            BL.CreateExam(
                "18", "2", lblExamcode.Text, txtexamname.Text, txtduration.Text,
                ddlnegativemarks.SelectedValue, txtnoofquestion.Text, txtexaminstruction.Text,
                DateTime.Now.ToString(), Erpuserid(), examDate, examTimeFrom, examTimeTo, txt_series_no.Text
            );
