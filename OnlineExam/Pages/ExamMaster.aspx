...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function calculateDuration() {
            var fromTime_ = document.querySelector('.txt_FromTime').value;
            var toTime_ = document.querySelector('.txt_ToTime').value;
            var duration_textBox = document.querySelector('.txtDuration');

            if (fromTime_ && toTime_) {
                var fromDate = new Date("2000-01-01 " + fromTime_);
                var toDate = new Date("2000-01-01 " + toTime_);
                            ...
                            <div class="list-group-item">
                                <div class="row g-1">
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox ID="txtduration" runat="server" CssClass="form-control form-control-sm txtDuration border-1 border-dark-secondary mb-2"></asp:TextBox>
