...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function startTimer() {
            ...
            var seconds = parseInt(hiddenField.value) || 3000; // 300 seconds = 5 minutes
    ...
    <form id="form1" runat="server">
        ...
        <div class="list-group">
            <div class="list-group-item bg">
                ...
                <h5 class="text-center text-uppercase" style="color: GrayText; font-weight: bold; text-align: center; font-size: 14px; line-height: normal">CES Foundation <small style="float: right; margin-right: 5px">Time remaining :
                    <div style="text-align: right; margin-right: 5px" id="timerDisplay"></div>
                </small></h5>
                <h3 class="text-center fw-bold text-uppercase">Vidyaniketan PU Science College, Hubballi
                </h3>
            ...
            <div class="list-group-item text-uppercase" style="background-image: url(css/images/bg.png)">
                <small class="text-left text-uppercase " style="float: left; color: purple; font-size: 14px; font-weight: 600">
                    <b style="color: cadetblue">Student Name :
                        <asp:Label ID="lblstudentname" runat="server"></asp:Label></b></small>
                <small class="text-left " style="float: right; color: purple; text-align: center; font-size: 14px; font-weight: 600"><b style="color: cadetblue">Student Id No :
                    <asp:Label ID="lblstudentidno" runat="server"></asp:Label></b></small>

                <br />

                <small style="float: left; color: purple; font-size: 14px; font-weight: 600"><b style="color: cadetblue">Course :
                    <asp:Label ID="lblcourse" runat="server"></asp:Label></b></small>
                <small style="float: right; color: purple; font-size: 14px; font-weight: 600;"><b style="color: cadetblue">Roll Number :
                    <asp:Label ID="lblrollno" runat="server"></asp:Label></b></small>
            ...
            <div class="list-group-item" style="background-image: url(css/images/bg.png)">
                ...
                <div>
                      <asp:LinkButton ID="lbPrevious" runat="server" CssClass="btn btn-primary" Enabled="false" OnClick="lbPrevious_Click">Prev</asp:LinkButton>
                    <asp:LinkButton ID="lbNext" runat="server" CssClass="btn btn-primary" OnClick="lbNext_Click">Next</asp:LinkButton>
        ...
        <asp:HiddenField ID="hfCurrentQuestionIndex" runat="server" />
